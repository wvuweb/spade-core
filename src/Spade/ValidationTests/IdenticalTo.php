...
class IdenticalTo extends ValidationTest {
	
	/**
	 * Check to see if this item is identical to the given value
	 * uses !== and not != (use equalto for latter)
	 *
	 * yaml use:
	 *   ModelName:
	 *     itemName: 
	...
	public function test($itemValue, $itemName = "", $props = array()) {
		...
		if ($itemValue !== $props["value"]) {
			$defaultMessage = "This value ".$itemName." should be identical to ".$props["value"].".";
